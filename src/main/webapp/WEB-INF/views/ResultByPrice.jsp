...
<form action="<%=resultPath%>/resultcarprice" method="post">
<table border="1">
<tr>
		<th></th>
        <th>Brand</th>
  ...
  <c:forEach items="${result}" var="item">
    <tr>
    <td> <input type="radio" name="price" value="${item.brand}  ${item.model}"><br></td>
  ...
  <tr>
  	...
  	<td colspan="7">
  		...
  		<a href="<%=resultPath%>/byprice">Back</a>
